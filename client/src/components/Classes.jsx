...
const Classes = props => (
  <div>
    ...
    <div>
      <h3>{props.classList.map(eachClass => <ClassListItem key={eachClass.name} teacherName={props.teacherName} teacherNumber={props.teacherNumber} eachClass={eachClass} />)}</h3>
    </div>
  </div>
);
